    ...
    <main className="min-h-dvh bg-paper text-ink">
      ...
      <article className="mx-auto max-w-2xl px-5 py-14 sm:px-6">
        <div className="prose-ewin space-y-5">
          ...
          <h2 className="font-serif text-[1.15rem] font-semibold text-ink">Not the exam boards</h2>
          <p>
          ...
          <h2 className="font-serif text-[1.15rem] font-semibold text-ink">Accounts &amp; billing</h2>
          <p>
          ...
          <h2 className="font-serif text-[1.15rem] font-semibold text-ink">Acceptable use</h2>
          <p>
