    ...
    <main className="min-h-dvh bg-paper text-ink">
      ...
      <div className="mx-auto max-w-2xl px-5 py-14 sm:px-6">
        <ul className="mt-8 space-y-4 text-sm">
          <li className="press rounded-2xl border border-line bg-surface p-5 shadow-[var(--shadow-sm)]">
            ...
            <a
              ...
              className="mt-3 inline-block font-medium text-primary no-underline hover:underline"
            >
              Join the server →
            </a>
          </li>
          <li className="press rounded-2xl border border-line bg-surface p-5 shadow-[var(--shadow-sm)]">
            ...
            <a href="mailto:support@ewin.academy" className="mt-3 inline-block font-medium text-primary no-underline hover:underline">
